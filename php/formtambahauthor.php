...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/styletambahauthor.css">
            ...
            <div class="main-content">
                <div class="wrapper">
                    <h1>                        
                        ...
                        <span class="author-text">Add Author</span>
                    </h1>
                    <hr>
                    <form method = "POST" action = "tambahauthor.php" enctype="multipart/form-data" autocomplete="off">
                        <div class="field">
