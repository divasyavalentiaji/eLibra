<?php
    ...
    // Fungsi untuk melakukan pencarian berdasarkan kolom pada tabel "author"
    function searchAuthor($keyword, $conn)
    {
        // Query untuk mencari penulis berdasarkan kolom pencarian
        $query = "SELECT * FROM author WHERE author_name LIKE '%$keyword%'";
    ...
    if (isset($_POST["search"])) {
        ...
        $result = searchAuthor($keyword, $conn);
    } else {
        // Jika tombol pencarian tidak ditekan, ambil semua data penulis
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/styledataauthor.css">
        <script>
            function confirmDelete($idAuthor) {
                if (confirm("Are you sure you want to delete this data?")) {
                    window.location.href = "deleteauthor.php?id_author=" + $idAuthor;
                }
            }
        </script>
    </head>
    <body>
        <div class="container">
            <div class="sidebar">
                <div class="header">
                    <div class="list-item">
                        <img src="../assets/logo.png" width="80%"><br>
                    </div>
                </div>
                <div class="admin">
                    <div class="list-item">
            ...
            <div class="main-content">
                <div class="wrapper">
                    <h1>                        
                        ...
                        <span class="author-text">Author Data</span>
                    </h1>
                    <hr>
                    <div class="searchandadd">
                        ...
                        <button class="addbutton">
                            <a href="formtambahauthor.php"><i class="fa-solid fa-plus" style="color: #ffffff;"></i> Add Data</a>
                        </button>
                    </div>
                    <table border="1">
                        <tr class="title">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-container">
                                    <button class="button update-button"><a href="formupdateauthor.php?id_author=<?php echo $row['id_author']; ?>"><i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i>   Update</a></button>
                                    <button class="button delete-button" onclick="confirmDelete(<?php echo $row['id_author']; ?>)"><i class="fa-solid fa-trash" style="color: #ffffff;"></i>   Delete</button>
                                </div>
                            </td>
                        </tr>
